      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item waves-effect waves-light active" style="width:20%;text-align: center">
          <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">
            <spam id="open_task_count">Your Open Tasks (<spam id="open_task_count_val"><?php if($open_task_count == 0) { echo 0; } else { echo count($open_task_count); } ?></spam>)</spam>
	                      ...
	                      <table class="table">
	                        ...
	                        <tr>
	                          <td colspan="2">
	                            ...
	                            <a href="javascript:" data-element="<?php echo $task->id?>" data-subject="<?php echo $subject; ?>" data-author="<?php echo $task->author; ?>" data-allocated="<?php echo $task->allocated_to; ?>"  class="fa fa-sitemap edit_allocate_user edit_allocate_user_<?php echo $task->id; ?> <?php echo $disabled; ?>" title="Allocate User" style="font-weight:800"></a>
	                            &nbsp;
	                      ...
	                      <table class="table">
	                        <tr>
	                          <td style="background:#2fd9ff" class="<?php echo $disabled_icon; ?>">
	                            ...
	                            <a href="javascript:" class="fa fa-files-o copy_task" data-element="<?php echo $task->id; ?>" title="Copy this Task" style="padding:5px;font-size:20px;font-weight: 800"></a></td>
	                        </tr>
	                        <tr>
	                          <td style="background:#2fd9ff"><spam style="font-weight:700;text-decoration: underline;">Task ID:</spam> <?php echo $task->taskid; ?></td>
	                        </tr>
	                        <tr>
	                          <td style="background:#2fd9ff">
	                            <spam style="font-weight:700;text-decoration: underline;">Progress:</spam> 
	                            <a href="javascript:" class="fa fa-sliders" title="Set progress" data-placement="bottom" data-popover-content="#a1_<?php echo $task->id; ?>" data-toggle="popover" data-trigger="click" tabindex="0" data-original-title="Set Progress"  style="padding:5px;font-weight:700"></a>
	                            ...
	                            <br/>
	                            <div class="progress progress_<?php echo $task->id; ?>" style="margin-top:20px">
	                        ...
	                        <tr>
	                          <td style="background:#2fd9ff">
	                            ...
	                            {
	                              ?>
	                              <a href="javascript:" class="common_black_button mark_as_incomplete" data-element="<?php echo $task->id; ?>">Completed</a>
	                              <?php
	                            }
	                            else{
	                              if(Session::has('taskmanager_user'))
	                              ...
	                              ?>
	                              <a href="javascript:" class="common_black_button <?php echo $complete_button; ?>" data-element="<?php echo $task->id; ?>">Mark Complete</a>
	                              <?php
	                            }
	                            ?>
...
$(window).click(function(e) {
  ...
  {
  	var r = confirm("You are about to mark this task as Complete. Please Note that this task will be allocated back to the author. Are you sure you want to continue?");
  	if(r)
  	{
  		$("body").addClass("loading");
	    var task_id = $(e.target).attr("data-element");
